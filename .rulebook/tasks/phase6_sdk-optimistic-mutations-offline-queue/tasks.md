...
- [ ] 1.6 Offline mutation queue: buffer calls while disconnected, replay in order on reconnect, each with a stable idempotency_key (CS-032, pairs with phase5_reducer-idempotency-keys)
