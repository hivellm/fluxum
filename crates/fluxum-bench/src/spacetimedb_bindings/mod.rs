...
pub mod add_task_reducer;
pub mod chat_message_table;
pub mod chat_message_type;
pub mod complete_task_reducer;
pub mod online_user_table;
pub mod online_user_type;
pub mod send_chat_budget_type;
pub mod send_chat_reducer;
pub mod task_table;
pub mod task_type;

pub use add_task_reducer::add_task;
pub use chat_message_table::*;
pub use chat_message_type::ChatMessage;
pub use complete_task_reducer::complete_task;
pub use online_user_table::*;
pub use online_user_type::OnlineUser;
pub use send_chat_budget_type::SendChatBudget;
...
pub enum Reducer {
    ...
    CompleteTask { id: u64 },
    SendChat { channel: u32, content: String },
}
...
impl __sdk::Reducer for Reducer {
    ...
    fn args_bsatn(&self) -> Result<Vec<u8>, __sats::bsatn::EncodeError> {
        match self {
            Reducer::AddTask { title } => __sats::bsatn::to_vec(&add_task_reducer::AddTaskArgs {
                title: title.clone(),
            }),
            Reducer::CompleteTask { id } => {
                __sats::bsatn::to_vec(&complete_task_reducer::CompleteTaskArgs { id: id.clone() })
            }
            Reducer::SendChat { channel, content } => {
...
pub struct DbUpdate {
    ...
    online_user: __sdk::TableUpdate<OnlineUser>,
    ...
    fn try_from(raw: __ws::v2::TransactionUpdate) -> Result<Self, Self::Error> {
        ...
        for table_update in __sdk::transaction_update_iter_table_updates(raw) {
            match &table_update.table_name[..] {
                ...
                "online_user" => db_update
                    .online_user
                    .append(online_user_table::parse_table_update(table_update)?),
                "task" => db_update
                    .task
...
impl __sdk::DbUpdate for DbUpdate {
    fn apply_to_client_cache(
        ...
        diff.online_user = cache
            .apply_diff_to_table::<OnlineUser>("online_user", &self.online_user)
            .with_updates_by_pk(|row| &row.connection);
        diff.task = cache
...
pub struct AppliedDiff<'r> {
    ...
    online_user: __sdk::TableAppliedDiff<'r, OnlineUser>,
...
impl<'r> __sdk::AppliedDiff<'r> for AppliedDiff<'r> {
    fn invoke_row_callbacks(
        ...
        callbacks.invoke_table_row_callbacks::<OnlineUser>("online_user", &self.online_user, event);
...
impl __sdk::SpacetimeModule for RemoteModule {
    ...
    fn register_tables(client_cache: &mut __sdk::ClientCache<Self>) {
        ...
        online_user_table::register_table(client_cache);
        task_table::register_table(client_cache);
    }
    const ALL_TABLE_NAMES: &'static [&'static str] = &["chat_message", "online_user", "task"];
}
